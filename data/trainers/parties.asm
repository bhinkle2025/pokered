...
; Route 3
	...
	db 11, BUTTERFREE, BUTTERFREE, 0
; Mt. Moon 1F
	db 11, BEEDRILL, SCYTHER, 0
	db 10, BUTTERFREE, PARAS, PINSIR, 0
; Route 24
...
; Route 3
	...
	db 14, JIGGLYPUFF, 0
; Route 4
	db 31, WIGGLYTUFF, PIDGEOT, PARASECT, 0
; Mt. Moon 1F
	db 11, ODDISH, BELLSPROUT, 0
	db 14, CLEFABLE, 0
; Route 24
	db 16, PIDGEOTTO, NIDORAN_F, 0
	db 14, PIDGEOTTO, NIDORAN_F, 0
; Route 25
	db 15, NIDORAN_M, NIDORAN_F, 0
	db 13, ODDISH, PIDGEOTTO, ODDISH, 0
; SS Anne 1F Rooms
...
; Route 8
	...
	db 19, PIDGEOTTO, RATTATA, NIDORAN_M, MEOWTH, PIKACHU, 0
...
; SS Anne B1F Rooms
	...
	db 17, HORSEA, KRABBY, SQUIRTLE, 0
	db 20, MACHOP, 0
; Vermilion Gym
...
; Route 6
	...
	db 16, PIDGEOTTO, CHARMANDER, BULBASAUR, 0
; Unused
	db 22, BULBASAUR, 0
; Route 9
	db 18, ODDISH, BELLSPROUT, ODDISH, IVYSAUR, 0
	db 23, MEOWTH, 0
; Route 10
	db 20, PIKACHU, CLEFAIRY, 0
	db 21, PIDGEOT, CHARMELEON, 0
; Rock Tunnel B1F
	db 21, JIGGLYPUFF, PIDGEOT, MEOWTH, 0
	db 22, GLOOM, IVYSAUR, 0
; Celadon Gym
	db 24, BULBASAUR, IVYSAUR, 0
; Route 13
	db 24, PIDGEOT, MEOWTH, RATTATA, PIKACHU, MEOWTH, 0
	db 30, POLIWAG, POLIWHIRL, 0
	db 27, PIDGEOT, MEOWTH, POLIWHIRL, RATICATE, 0
	db 28, GOLDEEN, POLIWAG, HORSEA, 0
; Route 20
	db 31, GOLDEEN, SEAKING, 0
; Rock Tunnel 1F
	db 22, WEEPINBELL, CLEFAIRY, 0
	db 20, MEOWTH, ODDISH, PIDGEOT, 0
...
; Rock Tunnel B1F
	db 20, SLOWPOKE, EEVEE, DRATINI, 0
...
; Route 8
	db 20, VOLTORB, KOFFING, KABUTO, MAGNEMITE, 0
	db 22, GRIMER, MUK, OMANYTE, 0
	db 26, KOFFING, 0
; Unused
...
; Route 9
	...
	db 20, GEODUDE, MACHOP, RHYHORN, 0
; Route 10
	db 21, GEODUDE, ONIX, 0
	db 19, ONIX, GRAVELER, 0
; Rock Tunnel B1F
	db 21, GEODUDE, KANGASKHAN, GRAVELER, 0
	db 25, GRAVELER, 0
...
SwimmerData:
; Cerulean Gym
	db 15, HORSEA, SQUIRTLE, 0
; Route 19
	db 30, TENTACOOL, SHELLDER, 0
	db 29, GOLDEEN, HORSEA, STARYU, 0
	db 30, POLIWAG, POLIWHIRL, 0
	db 27, HORSEA, TENTACOOL, SEEL, GOLDEEN, 0
	db 29, GOLDEEN, SHELLDER, SEAKING, 0
	db 30, HORSEA, SQUIRTLE, 0
	db 27, TENTACOOL, SEEL, STARYU, HORSEA, TENTACRUEL, 0
; Route 20
	db 31, SHELLDER, CLOYSTER, 0
	db 35, STARYU, 0
	db 28, HORSEA, GYARADOS, SEADRA, SEEL, 0
; Route 21
...
; Route 8
	db 22, KRABBY, POLIWAG, POLIWHIRL, 0
; Unused
...
; Route 19
	db 27, POLIWAG, KRABBY, SEAKING, GOLDEEN, SEEL, 0
	db 30, GOLDEEN, SEAKING, 0
	db 29, STARYU, KRABBY, WARTORTLE, 0
; Route 20
	db 30, SEADRA, HORSEA, VAPOREON, 0
...
BirdKeeperData:
; Route 13
	db 29, FEAROW, PIDGEOT, 0
	db 25, SPEAROW, PIDGEOT, DODUO, FARFETCHD, FEAROW, 0
	db 26, FARFETCHD, PIDGEOT, SPEAROW, FEAROW, 0
; Route 14
	db 33, FARFETCHD, 0
	db 29, DODRIO, FEAROW, 0
; Route 15
	db 26, PIDGEOT, FARFETCHD, DODUO, FEAROW, 0
	db 28, DODRIO, DODUO, DODUO, 0
; Route 18
	db 29, SPEAROW, FEAROW, 0
	db 34, DODRIO, 0
	db 26, DODUO, PIDGEOT, FEAROW, FARFETCHD, 0
; Route 20
	db 30, FARFETCHD, FEAROW, PIDGEOT, 0
; Unused
	db 39, PIDGEOTTO, PIDGEOTTO, PIDGEY, PIDGEOTTO, 0
	db 42, FARFETCHD, FEAROW, 0
; Route 14
	db 28, PIDGEOT, DODUO, PIDGEOTTO, 0
	db 26, PIDGEOTTO, SPEAROW, PIDGEOT, FEAROW, 0
...
; Victory Road 2F
	db 43, MACHOKE, MACHOP, MACHAMP, 0
...
; Silph Co. 6F
	db 25, VOLTORB, KOFFING, MAGNETON, MAGNEMITE, PORYGON, 0
; Silph Co. 7F
...
; Mansion 3F
	db 33, MAGNEMITE, MAGNETON, JOLTEON, 0
; Mansion B1F
...
; Viridian Gym
	db $FF, 49, MAROWAK, 49, DUGTRIO, 49, NIDOQUEEN, 49, NIDOKING, 50, RHYDON, 0
...
; Victory Road 3F
	...
	db 43, KINGLER, TENTACRUEL, SNORLAX, 0
; Unused
...
BrunoData:
	db $FF, 56, ONIX, 56, HITMONCHAN, 56, HITMONLEE, 56, POLIWRATH, 58, MACHAMP, 0
...
LtSurgeData:
	...
	; Rematch
	db $FF, 62, ELECTRODE, 63, JOLTEON, 63, ELECTABUZZ, 64, MAGNETON, 64, RAICHU, 0

ErikaData:
	db $FF, 29, VICTREEBEL, 29, TANGELA, 29, VILEPLUME, 0
; Rematch
	db $FF, 62, VICTREEBEL, 63, PARASECT, 63, TANGELA, 64, EXEGGUTOR, 64, VILEPLUME, 0

KogaData:
	db $FF, 43, WEEZING, 43, MUK, 43, GOLBAT, 44, VENOMOTH, 0
; Rematch
	db $FF, 62, WEEZING, 63, TENTACRUEL, 63, MUK, 64, GOLBAT, 64, VENOMOTH, 0

BlaineData:
	db $FF, 47, MAGMAR, 47, RAPIDASH, 47, NINETALES, 48, FLAREON, 48, ARCANINE, 0
; Rematch
	db $FF, 62, MAGMAR, 63, RAPIDASH, 63, NINETALES, 64, FLAREON, 64, ARCANINE, 0
...
; Silph Co. 7F
	db $FF, 37, PIDGEOT, 38, GROWLITHE, 35, EXEGGCUTE, 35, KADABRA, 40, BLASTOISE, 0
	db $FF, 37, PIDGEOT, 38, GYARADOS, 35, GROWLITHE, 35, KADABRA, 40, VENUSAUR, 0
	db $FF, 37, PIDGEOT, 38, EXEGGCUTE, 35, GYARADOS, 35, KADABRA, 40, CHARIZARD, 0
; Route 22
...
Green3Data:
	db $FF, 62, PIDGEOT, 62, ALAKAZAM, 62, RHYDON, 62, ARCANINE, 64, EXEGGUTOR, 66, BLASTOISE, 0
	db $FF, 62, PIDGEOT, 62, ALAKAZAM, 62, RHYDON, 62, GYARADOS, 64, ARCANINE, 66, VENUSAUR, 0
	db $FF, 62, PIDGEOT, 62, ALAKAZAM, 62, RHYDON, 62, EXEGGUTOR, 64, GYARADOS, 66, CHARIZARD, 0

LoreleiData:
	db $FF, 54, DEWGONG, 54, CLOYSTER, 54, SLOWBRO, 56, JYNX, 56, LAPRAS, 0
...
AgathaData:
	db $FF, 58, GOLBAT, 58, RATICATE, 58, ARBOK, 60, HAUNTER, 60, GENGAR, 0
