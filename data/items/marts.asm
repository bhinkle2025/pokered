...
VermilionMartClerkText::
	script_mart POKE_BALL, SUPER_POTION, ICE_HEAL, AWAKENING, PARLYZ_HEAL

LavenderMartClerkText::
	script_mart GREAT_BALL, SUPER_POTION, REVIVE, ANTIDOTE, BURN_HEAL, ICE_HEAL, PARLYZ_HEAL
...
CeladonMart2FClerk2Text::
	script_mart TM_DOUBLE_TEAM, TM_REFLECT, TM_FLAMETHROWER, TM_SLUDGE, TM_OUTRAGE, TM_MEGA_PUNCH, TM_MEGA_KICK, TM_GIGA_IMPACT, TM_SUBMISSION
...
FuchsiaMartClerkText::
	script_mart ULTRA_BALL, GREAT_BALL, SUPER_POTION, REVIVE, FULL_HEAL

UnusedMartClerkText:: ; unreferenced
	script_mart GREAT_BALL, HYPER_POTION, SUPER_POTION, FULL_HEAL, REVIVE

CinnabarMartClerkText::
	script_mart ULTRA_BALL, GREAT_BALL, HYPER_POTION, MAX_REPEL, FULL_HEAL, REVIVE

SaffronMartClerkText::
	script_mart GREAT_BALL, HYPER_POTION,  FULL_HEAL, REVIVE

IndigoPlateauLobbyClerkText::
	script_mart ULTRA_BALL, GREAT_BALL, FULL_RESTORE, MAX_POTION, FULL_HEAL, REVIVE
