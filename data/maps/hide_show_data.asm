...
Route2HS:
	...
	db ROUTE_2, ROUTE2_EXP_CANDY_S,      SHOW
Route4HS:
...
Route12HS:
	...
	db ROUTE_12, ROUTE12_EXP_CANDY_M,       SHOW
Route15HS:
...
PokemonTower4FHS:
	...
	db POKEMON_TOWER_4F, POKEMONTOWER4F_EXP_CANDY_M,     SHOW
PokemonTower5FHS:
...
PokemonMansion1FHS:
	...
	db POKEMON_MANSION_1F, POKEMONMANSION1F_EXP_CANDY_L,      SHOW
FightingDojoHS:
...
PowerPlantHS:
	...
	db POWER_PLANT, POWERPLANT_EXP_CANDY_M,     SHOW
	db POWER_PLANT, POWERPLANT_EXP_CANDY_L,SHOW
...
RocketHideoutB4FHS:
	...
	db ROCKET_HIDEOUT_B4F, ROCKETHIDEOUTB4F_EXP_CANDY_M,   SHOW
...
SilphCo5FHS:
	...
	db SILPH_CO_5F, SILPHCO5F_EXP_CANDY_M,  SHOW
...
SilphCo6FHS:
	...
	db SILPH_CO_6F, SILPHCO6F_EXP_CANDY_L,SHOW
...
SilphCo7FHS:
	...
	db SILPH_CO_7F, SILPHCO7F_EXP_CANDY_S,     SHOW
...
PokemonMansion2FHS:
	db POKEMON_MANSION_2F, POKEMONMANSION2F_EXP_CANDY_M, SHOW
PokemonMansion3FHS:
	db POKEMON_MANSION_3F, POKEMONMANSION3F_MAX_POTION, SHOW
	db POKEMON_MANSION_3F, POKEMONMANSION3F_EXP_CANDY_XL, SHOW
PokemonMansionB1FHS:
...
SafariZoneEastHS:
	...
	db SAFARI_ZONE_EAST, SAFARIZONEEAST_EXP_CANDY_M,       SHOW
	db SAFARI_ZONE_EAST, SAFARIZONEEAST_TM_OUTRAGE,  SHOW
SafariZoneNorthHS:
	db SAFARI_ZONE_NORTH, SAFARIZONENORTH_EXP_CANDY_L,       SHOW
