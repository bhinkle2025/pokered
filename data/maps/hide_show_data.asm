...
CeruleanCityHS:
	...
	db CERULEAN_CITY, CERULEANCITY_GREEN,       SHOW
SaffronCityHS:
...
Route2HS:
	...
	db ROUTE_2, ROUTE2_RARE_CANDY,      SHOW
Route4HS:
	db ROUTE_4, ROUTE4_TM_FIRE_PUNCH, SHOW
Route9HS:
	db ROUTE_9, ROUTE9_TM_CALM_MIND, SHOW
Route12HS:
	db ROUTE_12, ROUTE12_SNORLAX,    SHOW
	db ROUTE_12, ROUTE12_TM_THUNDERPUNCH, SHOW
	db ROUTE_12, ROUTE12_RARE_CANDY,       SHOW
Route15HS:
	db ROUTE_15, ROUTE15_TM_ICE_PUNCH, SHOW
Route16HS:
...
PokemonTower3FHS:
	db POKEMON_TOWER_3F, POKEMONTOWER3F_RARE_CANDY, SHOW
PokemonTower4FHS:
	db POKEMON_TOWER_4F, POKEMONTOWER4F_ELIXER,    SHOW
	db POKEMON_TOWER_4F, POKEMONTOWER4F_AWAKENING, SHOW
	db POKEMON_TOWER_4F, POKEMONTOWER4F_RARE_CANDY,     SHOW
PokemonTower5FHS:
...
PokemonMansion1FHS:
	db POKEMON_MANSION_1F, POKEMONMANSION1F_BOTTLE_CAP, SHOW
	db POKEMON_MANSION_1F, POKEMONMANSION1F_RARE_CANDY,      SHOW
FightingDojoHS:
...
PowerPlantHS:
	...
	db POWER_PLANT, POWERPLANT_RARE_CANDY_1,     SHOW
	db POWER_PLANT, POWERPLANT_RARE_CANDY_2,SHOW
	db POWER_PLANT, POWERPLANT_RARE_CANDY_3, SHOW
...
VictoryRoad2FHS:
	...
	db VICTORY_ROAD_2F, VICTORYROAD2F_TM_HYPER_BEAM,  SHOW
...
RocketHideoutB1FHS:
	db ROCKET_HIDEOUT_B1F, ROCKETHIDEOUTB1F_BOTTLE_CAP,  SHOW
...
RocketHideoutB2FHS:
	...
	db ROCKET_HIDEOUT_B2F, ROCKETHIDEOUTB2F_TM_LIGHT_SCREEN, SHOW
...
RocketHideoutB4FHS:
	...
	db ROCKET_HIDEOUT_B4F, ROCKETHIDEOUTB4F_RARE_CANDY_1,   SHOW
	db ROCKET_HIDEOUT_B4F, ROCKETHIDEOUTB4F_TM_MEGA_KICK,  SHOW
	db ROCKET_HIDEOUT_B4F, ROCKETHIDEOUTB4F_RARE_CANDY_2,   SHOW
...
SilphCo4FHS:
	...
	db SILPH_CO_4F, SILPHCO4F_BOTTLE_CAP, SHOW
SilphCo5FHS:
	...
	db SILPH_CO_5F, SILPHCO5F_TM_GIGA_IMPACT, SHOW
	db SILPH_CO_5F, SILPHCO5F_RARE_CANDY,  SHOW
...
SilphCo6FHS:
	...
	db SILPH_CO_6F, SILPHCO6F_RARE_CANDY,SHOW
...
SilphCo7FHS:
	...
	db SILPH_CO_7F, SILPHCO7F_RARE_CANDY,     SHOW
...
SilphCo10FHS:
	...
	db SILPH_CO_10F, SILPHCO10F_TM_SHADOW_CLAW,  SHOW
	db SILPH_CO_10F, SILPHCO10F_RARE_CANDY,     SHOW
	db SILPH_CO_10F, SILPHCO10F_TM_DRAGON_RAGE,         SHOW
SilphCo11FHS:
...
PokemonMansion2FHS:
	db POKEMON_MANSION_2F, POKEMONMANSION2F_RARE_CANDY, SHOW
PokemonMansion3FHS:
	db POKEMON_MANSION_3F, POKEMONMANSION3F_MAX_POTION, SHOW
	db POKEMON_MANSION_3F, POKEMONMANSION3F_RARE_CANDY, SHOW
PokemonMansionB1FHS:
...
SafariZoneEastHS:
	...
	db SAFARI_ZONE_EAST, SAFARIZONEEAST_RARE_CANDY,       SHOW
	db SAFARI_ZONE_EAST, SAFARIZONEEAST_TM_OUTRAGE,  SHOW
SafariZoneNorthHS:
	db SAFARI_ZONE_NORTH, SAFARIZONENORTH_RARE_CANDY,       SHOW
