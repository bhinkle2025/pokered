	...
	const_export MTMOON1F_REPEL1
	const_export MTMOON1F_MOON_STONE
	const_export MTMOON1F_RARE_CANDY
	const_export MTMOON1F_BOTTLE_CAP
	const_export MTMOON1F_POTION2
	const_export MTMOON1F_TM_STEEL_WING
...
MtMoon1F_Object:
	...
	object_event  2, 20, SPRITE_POKE_BALL, STAY, NONE, TEXT_MTMOON1F_REPEL1, REPEL
	...
	object_event 36, 23, SPRITE_POKE_BALL, STAY, NONE, TEXT_MTMOON1F_BOTTLE_CAP, BOTTLE_CAP
	object_event 20, 33, SPRITE_POKE_BALL, STAY, NONE, TEXT_MTMOON1F_POTION2, POTION
	object_event  5, 32, SPRITE_POKE_BALL, STAY, NONE, TEXT_MTMOON1F_TM_STEEL_WING, TM_STEEL_WING
