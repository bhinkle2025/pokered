	...
	const_export ROCKETHIDEOUTB4F_RARE_CANDY_1
	const_export ROCKETHIDEOUTB4F_TM_MEGA_KICK
	const_export ROCKETHIDEOUTB4F_RARE_CANDY_2
...
RocketHideoutB4F_Object:
	...
	object_event 10, 12, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROCKETHIDEOUTB4F_RARE_CANDY_1, RARE_CANDY
	object_event  9,  4, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROCKETHIDEOUTB4F_TM_MEGA_KICK, TM_MEGA_KICK
	object_event 12, 20, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROCKETHIDEOUTB4F_RARE_CANDY_2, RARE_CANDY
