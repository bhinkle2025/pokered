	...
	const_export ROUTE12_TM_THUNDERPUNCH
	const_export ROUTE12_EXP_CANDY_M
...
Route12_Object:
	...
	object_event 14, 35, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROUTE12_TM_THUNDERPUNCH, TM_THUNDERPUNCH
	object_event  5, 89, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROUTE12_EXP_CANDY_M, EXP_CANDY_M
