	...
	const_export SILPHCO5F_TM_GIGA_IMPACT
	const_export SILPHCO5F_EXP_CANDY_M
...
SilphCo5F_Object:
	...
	object_event  2, 13, SPRITE_POKE_BALL, STAY, NONE, TEXT_SILPHCO5F_TM_GIGA_IMPACT, TM_GIGA_IMPACT
	object_event  4,  6, SPRITE_POKE_BALL, STAY, NONE, TEXT_SILPHCO5F_EXP_CANDY_M, EXP_CANDY_M
