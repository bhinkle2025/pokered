	...
	const_export POKEMONMANSION1F_BOTTLE_CAP
	const_export POKEMONMANSION1F_EXP_CANDY_L
...
PokemonMansion1F_Object:
	...
	object_event 14,  3, SPRITE_POKE_BALL, STAY, NONE, TEXT_POKEMONMANSION1F_BOTTLE_CAP, BOTTLE_CAP
	object_event 18, 21, SPRITE_POKE_BALL, STAY, NONE, TEXT_POKEMONMANSION1F_EXP_CANDY_L,EXP_CANDY_L
