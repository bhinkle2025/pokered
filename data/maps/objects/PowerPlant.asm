	...
	const_export POWERPLANT_RARE_CANDY_1
	const_export POWERPLANT_RARE_CANDY_2
	const_export POWERPLANT_RARE_CANDY_3
...
PowerPlant_Object:
	...
	object_event  7, 25, SPRITE_POKE_BALL, STAY, NONE, TEXT_POWERPLANT_RARE_CANDY_1, RARE_CANDY
	object_event 28,  3, SPRITE_POKE_BALL, STAY, NONE, TEXT_POWERPLANT_RARE_CANDY_2, RARE_CANDY
	object_event 34,  3, SPRITE_POKE_BALL, STAY, NONE, TEXT_POWERPLANT_RARE_CANDY_3, RARE_CANDY
