	...
	const_export POWERPLANT_EXP_CANDY_M
	const_export POWERPLANT_EXP_CANDY_L
...
PowerPlant_Object:
	...
	object_event  7, 25, SPRITE_POKE_BALL, STAY, NONE, TEXT_POWERPLANT_EXP_CANDY_L, EXP_CANDY_M
	object_event 28,  3, SPRITE_POKE_BALL, STAY, NONE, TEXT_POWERPLANT_EXP_CANDY_L, EXP_CANDY_L
