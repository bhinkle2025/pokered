	...
	const_export SAFARIZONEEAST_EXP_CANDY_M
	const_export SAFARIZONEEAST_TM_OUTRAGE
...
SafariZoneEast_Object:
	...
	object_event 20, 13, SPRITE_POKE_BALL, STAY, NONE, TEXT_SAFARIZONEEAST_EXP_CANDY_M, EXP_CANDY_M
	object_event 15, 12, SPRITE_POKE_BALL, STAY, NONE, TEXT_SAFARIZONEEAST_TM_OUTRAGE, TM_OUTRAGE
